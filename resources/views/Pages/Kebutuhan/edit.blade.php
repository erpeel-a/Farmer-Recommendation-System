              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="wilayah_id" id="wilayah_id" class="form-control @error('wilayah_id') is-invalid @enderror">
                    ...
                    @foreach ($wilayah as $w)
                      <option {{ $w->id == $kebutuhan->wilayah_id ? ' selected' : '' }} value="{{ $w->id }}">{{ $w->nama_wilayah }}</option>
                    @endforeach
                  </select>
                  @error('wilayah_id')
                ...
                <div class="form-group">
                  ...
                  <select name="satuan_id" id="satuan_id" class="form-control @error('satuan_id') is-invalid @enderror">
                    @foreach ($satuan as $s)
                      <option {{ $s->id == $kebutuhan->satuan_id ? ' selected' : '' }} value="{{ $s->id }}">{{ $s->nama_satuan }}</option>
                    @endforeach
                  </select>
                  @error('satuan_id')
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="nama_kebutuhan" class="form-control @error('nama_kebutuhan') is-invalid @enderror" name="nama_kebutuhan" autofocus="" value="{{ $kebutuhan->nama_kebutuhan }}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="harga_kebutuhan" class="form-control @error('harga_kebutuhan') is-invalid @enderror" name="harga_kebutuhan" autofocus="" value="{{ $kebutuhan->harga_kebutuhan }}">
                ...
                <div class="form-group">
                  ...
                  <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" cols="200" rows="200">{{ $kebutuhan->keterangan }}</textarea>
                  @error('keterangan')
                    <div class="invalid-feedback">
                      {{$message}}
                    </div>
